...
@interface GuidePageTwoViewController ()
...
- (UILabel *)serviceLabel {
    if (_serviceLabel == nil) {
        ...
        [_serviceLabel setText:@"Rewards Programme"];
    }
...
- (UITextView *)serviceTextView {
    if (_serviceTextView == nil) {
        ...
        [_serviceTextView setText:@"Earning CAKNOW points is easy. Redeem points towards future repairs and gift cards!"];
    }
...
- (UIImageView *)backgroundImageView {
    if (_backgroundImageView == nil) {
        ...
        _backgroundImageView.image = [UIImage imageNamed:kBackgroundguidepage02];
    }
