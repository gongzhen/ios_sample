...
@protocol  GZLazyScrollViewCellProtocol<NSObject>
 ...
 */
@interface GZRectModel: NSObject
...
@class GZLazyScrollView;

@protocol GZLazyScrollViewDataSource <NSObject>

@required
- (NSUInteger)numberOfItemInScrollView:(nonnull GZLazyScrollView *)scrollView; // 0 by default.
...
////////////////////////////////////////////////////////////////////////////////////////////////////
@protocol GZLazyScrollViewDelegate<NSObject, UIScrollViewDelegate>

@end

////////////////////////////////////////////////////////////////////////////////////////////////////

@interface GZLazyScrollView : UIScrollView

@property (nonatomic, weak, nullable) id <GZLazyScrollViewDataSource> dataSource;
